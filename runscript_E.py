...
file_name = "sp_table2VecE.csv"
split_filename = "table2VecE.csv"
model_name = "model_table2VecE"
index_files = "table2VecE.idx"
query_file_name = "queries.txt"
ranked_file  = "bm25_table2VecE.idx"
output_rank_file = "table2VecE.out"
